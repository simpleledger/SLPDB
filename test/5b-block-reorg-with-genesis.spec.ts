...
describe("5b-Reorg-Removes-Data", () => {

    step("BR-3: Initial setup for all tests", async () => {
    ...
    step("BR-3: Produces ZMQ output at block", async () => {
        // clear ZMQ cache
    ...
    step("BR-3: Mine a longer chain on node 2 and broadcast txn into the mempool.", async () => {
